...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:d8KOgLpYiC+Xq3T4tuO+/goM+RZvuO+T4pojuv8giL8=",
        version = "v0.10.9",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Y2J74o+yAfcD8jpqtkLnUqRo+yshLr4eR1WPYGX0cic=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:7GcKy4erEljCE/QeQ2jTVpu+3f3zkpZOxOJjFYkMqYU=",
        version = "v0.3.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jfESivXnO5uLdH650JU/6AnjRoHrLhULq0FnC3Kp9EY=",
        version = "v1.4.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:gP70EZVHpJuUIT0YWth192JmlIci+qMOEByHm83XE9E=",
        version = "v1.18.0",
    )
    go_repository(
        ...
        sum = "h1:oWmCoA81Z7kCk26hiRGNrlJ8TWmpb3/ImO0EYdhoXBw=",
        version = "v2.7.0",
    )
    go_repository(
        name = "com_github_micro_go_plugins_registry_consul_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/micro/go-plugins/registry/consul/v2",
        sum = "h1:SJB2Hx1AjYSwx/eZ7CYLBI1RgPI4/G1N+qRUW2Zh88M=",
        version = "v2.5.0",
    )
    go_repository(
        name = "com_github_micro_go_plugins_registry_etcd_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/micro/go-plugins/registry/etcd/v2",
        sum = "h1:KpECgKjYpOj+Yq25u+uN4OlHMDRHi0IhRfQ1dSq0iNc=",
        version = "v2.5.0",
    )
    go_repository(
        name = "com_github_micro_go_plugins_registry_etcdv3_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/micro/go-plugins/registry/etcdv3/v2",
        sum = "h1:lN0prsgvNCRbV2Pb+ti2OIcD+WdUg/zbawDshUG61D0=",
        version = "v2.5.0",
    )
    go_repository(
        name = "com_github_micro_go_plugins_registry_kubernetes_v2",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/micro/go-plugins/registry/kubernetes/v2",
        sum = "h1:SJr/KhFMxSffmbR5li0Eec7tBxD6QXXCNAc+l4NGwPo=",
        version = "v2.5.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_micro_protoc_gen_micro",
        build_file_proto_mode = "disable_global",
        importpath = "github.com/micro/protoc-gen-micro",
        sum = "h1:qKh5S3I1RfenhIs5mqDFJLwRlRDlgin7XWiUKZbpwLM=",
        version = "v1.0.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:71ivoESdfT2K/qDiw5YwX/3W9/dR7c+m83xiGOj/EZ4=",
        version = "v1.0.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jCoQwDvRYJy3OpOTHeYfvIPLP46BMeDmH7XEJg/r42I=",
        version = "v2.1.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:G6CNEgFU8/XwexSnuFw+Jq/WePjRitgy6ofBcPnAIPo=",
        version = "v0.0.0-20200529172331-a64b76657301",
    )
    go_repository(
